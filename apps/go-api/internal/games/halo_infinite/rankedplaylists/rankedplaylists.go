...
var all = []Playlist{
	...
	{AssetID: "28bfa5f4-89b0-47dc-86e8-1a7cc5b593fc", NameEN: "RANKED 1V1 SHOWDOWN", NameFR: "Duel classé", Queue: "open-queue", Input: "crossplay", Active: false},
	{AssetID: "a4a4453c-7a91-4b27-b952-2456c5ce3205", NameEN: "Ranked S&D Extraction", NameFR: "Extraction classée", Queue: "open-queue", Input: "crossplay", Active: false},
	{AssetID: "6dc5f699-d6d9-41c4-bdf8-7ae11dec2d1b", NameEN: "Ranked Squad Battle", NameFR: "Bataille d'escouade classée", Queue: "open-queue", Input: "crossplay", Active: false},
	{AssetID: "f3738fae-bd09-4fd1-9dea-e32f546bbbfd", NameEN: "Ranked Survivors", NameFR: "Survivants classés", Queue: "open-queue", Input: "crossplay", Active: false},
	{AssetID: "0b42053a-32c5-4c2d-b8b8-5f07274a0117", NameEN: "HaloWC FFA Qualifier", NameFR: "Qualifications HaloWC (Chacun pour soi)", Queue: "open-queue", Input: "crossplay", Active: false},
	{AssetID: "7c60fb3e-656c-4ada-a085-293562642e50", NameEN: "RANKED TACTICAL OLD", NameFR: "Tactique classé (ancien)", Queue: "open-queue", Input: "crossplay", Active: false},
	{AssetID: "a883e7e1-9aca-4296-9009-3733a0ca8081", NameEN: "RANKED SNIPERS OLD", NameFR: "Snipers classés (ancien)", Queue: "open-queue", Input: "crossplay", Active: false},
