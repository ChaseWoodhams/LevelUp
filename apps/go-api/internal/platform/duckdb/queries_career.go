...
SELECT
    ...
    r.map_name,
    r.map_name                AS map_name_fr,
    r.pair_name,
    r.pair_name              AS pair_name_fr,
    r.pair_id,
...
SELECT
    ...
    map_name,
    map_name                AS map_name_fr,
    pair_name,
    pair_name              AS pair_name_fr,
    pair_id,
...
SELECT
    ...
    COALESCE(r.is_ranked, FALSE)                                           AS is_ranked,
    ` + StartTimeCanonicalSQL("r") + `            AS start_time,
    COALESCE(NULLIF(r.pair_name, ''), '')                  AS pair_name_source,
    COALESCE(NULLIF(r.playlist_name, ''), '')          AS playlist_name_source,
