/**
 * COPIED FILE — origin: apps/web/src/features/match-replay/coverageLogic.ts
 * Origin at commit: dd020364a — the commit that last changed it, so
 * `git diff dd020364a HEAD -- <origin>` is what the origin has learnt since.
 *
