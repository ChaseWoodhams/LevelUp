/**
 * COPIED FILE — origin: apps/web/src/features/match-replay/replayContract.test.ts
 * Origin at commit: 1825bb516 — the commit that last changed it, so
 * `git diff 1825bb516 HEAD -- <origin>` is what the origin has learnt since.
 *
