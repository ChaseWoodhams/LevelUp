/**
 * COPIED FILE — origin: apps/web/src/lib/accessibility/_logger.ts
 * Origin at commit: 178b4fecc — the commit that last changed it, so
 * `git diff 178b4fecc HEAD -- <origin>` is what the origin has learnt since.
 *
