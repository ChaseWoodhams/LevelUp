/**
 * COPIED FILE — origin: apps/web/src/lib/accessibility/semantic-tokens.ts
 * Origin at commit: a13d83233 — the commit that last changed it, so
 * `git diff a13d83233 HEAD -- <origin>` is what the origin has learnt since.
 *
