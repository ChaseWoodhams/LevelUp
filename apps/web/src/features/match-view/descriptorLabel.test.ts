...
describe('buildDescriptorLabel', () => {
  ...
  describe('kind = playlist', () => {
    it('FR : "en <name>"', () => {
      expect(
        buildDescriptorLabel({ kind: 'playlist', name: 'Classée Arena' }, 'en'),
  ...
  describe('kind = mode', () => {
    it('FR : "en <category>"', () => {
      expect(buildDescriptorLabel({ kind: 'mode', category: 'BTB' }, 'en')).toBe('en BTB')
    })
    it('EN : "in <category>"', () => {
